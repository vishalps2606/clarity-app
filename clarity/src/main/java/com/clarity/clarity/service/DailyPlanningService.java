...
public class DailyPlanningService {
    ...
    // In the future, this could come from User Settings or AI Insights.
    ...
    public void validateDayCapacity(LocalDate date, long newBlockMinutes) {
        ...
        List<TimeBlock> dailyBlocks = timeBlockRepository.findByStartTimeBetween(startOfDay, endOfDay);
